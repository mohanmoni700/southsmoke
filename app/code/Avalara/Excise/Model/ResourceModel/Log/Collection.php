...
namespace Avalara\Excise\Model\ResourceModel\Log;

use Avalara\Excise\Model\ResourceModel\Log;
...
class Collection extends AbstractCollection
{
    ...
    {
        $this->_init(
            \Avalara\Excise\Model\Log::class,
            \Avalara\Excise\Model\ResourceModel\Log::class
        );
    }
