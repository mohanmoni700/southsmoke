define([
    ...
    'Avalara_Excise/js/action/set-customer-address',
    ...
    $.widget('Avalara_Excise.addressValidationModal', $.mage.modal, {
        options: {
        ...
        handleFormSubmit: function () {
            ...
            $(self.formSelector).data('avalaraExciseAddressValidationEnabled', self.options.validationEnabled);
    ...
    return $.Avalara_Excise.addressValidationModal;
});
