 ...
 */
namespace Avalara\Excise\BaseProvider\Logger\Handler\Generic;

use Avalara\Excise\BaseProvider\Logger\Handler\BaseAbstractHandler;
use Avalara\Excise\BaseProvider\Logger\GenericLogger;
use Avalara\Excise\BaseProvider\Helper\Generic\Config;
use Magento\Framework\Webapi\Rest\Request;
use Avalara\Excise\BaseProvider\Model\Queue\Producer as QueueProducer;
...
class ApiHandler extends BaseAbstractHandler
{
    ...
    public function write(array $record) : void
    {
        ...
        if ($isValid) {
            ...
            $queueClient  = \Avalara\Excise\BaseProvider\Model\Queue\Consumer\ApiLogConsumer::CLIENT;
            $payload = [
                "setClient" => [
                    $endPointBaseUrl,
                    $accessToken,
