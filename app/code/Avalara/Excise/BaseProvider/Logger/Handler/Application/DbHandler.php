 ...
 */
namespace Avalara\Excise\BaseProvider\Logger\Handler\Application;

use Avalara\Excise\BaseProvider\Model\Config\Source\Application\LoggingMode;
use Monolog\Logger;
use Avalara\Excise\BaseProvider\Logger\Handler\BaseAbstractHandler;
use Avalara\Excise\BaseProvider\Helper\Application\Config;
use Avalara\Excise\BaseProvider\Model\LogFactory;
...
class DbHandler extends BaseAbstractHandler
{
    ...
    public function write(array $record) : void
    {
        parent::write($record);
        # Log to database
        /** @var \Avalara\Excise\BaseProvider\Model\Log $log */
