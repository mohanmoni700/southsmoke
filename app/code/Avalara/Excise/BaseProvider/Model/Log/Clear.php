 ...
 */
namespace Avalara\Excise\BaseProvider\Model\Log;

use Psr\Log\LoggerInterface;
use Avalara\Excise\BaseProvider\Helper\Application\Config as ApplicationLoggerConfig;
use Avalara\Excise\BaseProvider\Model\ResourceModel\Log\CollectionFactory as LogCollFactory;
        ...
        foreach ($logs as $log) {
            try {
                ...
                try {
                    ...
                    $this->applicationLogger->logDebugMessage(
                        $functionName,
                        $operationName,
                        $e
                    );
