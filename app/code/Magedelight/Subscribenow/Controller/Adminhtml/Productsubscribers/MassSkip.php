...
class MassSkip extends AbstractMassAction
{
    ...
    public function execute()
    {
        ...
        foreach ($collection as $model) {
            if ($model->getId() && $this->isActive($model)) {
                ...
                $subscriptionModel->skipSubscription(ProductSubscriptionHistory::HISTORY_BY_ADMIN);
        ...
        if ($records) {
            $this->messageManager->addSuccessMessage(__('A total of %1 record(s) have been skipped.', $records));
        } else {
