    ...
    public function execute()
    {
        ...
        foreach ($collection as $model) {
            if ($model->getId() && $this->isActive($model)) {
                ...
                $subscriptionModel->pauseSubscription(ProductSubscriptionHistory::HISTORY_BY_ADMIN);
        ...
        if ($records) {
            $this->messageManager->addSuccessMessage(__('A total of %1 record(s) have been paused.', $records));
        } else {
