...
class Paymentedit extends AbstractSubscriptionAction
{
    /**
    ...
    public function execute()
    {
        ...
        if ($model->getId()) {
            try {
                ...
                $this->messageManager->addSuccessMessage(__('Subscription Payment has been successfully updated.'));
         ...
         return $resultRedirect->setPath('*/*/payment', ['id' => $id]);
    }
}
