...
class Productedit extends AbstractSubscriptionAction
{
    /**
    ...
    public function execute()
    {
        ...
        if ($model->getId()) {
            try {
                ...
                $this->messageManager->addSuccessMessage(__('Subscription product has been successfully updated.'));
         ...
         return $resultRedirect->setPath('*/*/product', ['id' => $id]);
    }
}
