...
class InitAmount extends AbstractTotal
{
    ...
    {
        $creditmemo->setSubscribenowInitAmount(0);
        $creditmemo->setBaseSubscribenowInitAmount(0);
        
        $amount = $creditmemo->getOrder()->getSubscribenowInitAmount();
        $creditmemo->setSubscribenowInitAmount($amount);
        $creditmemo->setGrandTotal($creditmemo->getGrandTotal() + $amount);

        $baseAmount = $creditmemo->getOrder()->getBaseSubscribenowInitAmount();
        $creditmemo->setBaseSubscribenowInitAmount($baseAmount);
