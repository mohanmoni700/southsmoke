 ...
 * Class Trialcycle
 */
class NumberOfTrialCycle extends \Magento\Eav\Model\Entity\Attribute\Backend\AbstractBackend
{
        ...
        if ($value) {
            if (!is_numeric($value) || $value < $minimumValueLength) {
                throw new \Magento\Framework\Exception\LocalizedException(
                    __('The value of attribute "Number Of Trial Cycle" must be 0 or greater')
                );
            }
        }
